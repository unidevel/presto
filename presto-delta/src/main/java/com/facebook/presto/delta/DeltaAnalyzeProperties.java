...
public class DeltaAnalyzeProperties
{
    ...
    @Inject
    public DeltaAnalyzeProperties(TypeManager typeManager)
    {
        analyzeProperties = ImmutableList.of(
                new PropertyMetadata<>(
                        ...
                        null,
                        false,
                        DeltaAnalyzeProperties::decodePartitionLists,
                        value -> value));
    }
    ...
    private static List<List<String>> decodePartitionLists(Object object)
    {
        ...
        return ImmutableList.copyOf(((Collection<?>) object).stream()
                .peek(DeltaAnalyzeProperties::throwIfNull)
